...
$options['client_id'] = 'YXA6_-SwcP_SEeS3P5UjO6_B5A';
$options['client_secret'] = 'YXA6cVhm4-8Id70wDbFvwibw9tUMy00';
$options['org_name'] = 'haoyayi';
$options['app_name'] = 'haoyayidocdev';
...
$action = "user.kick";
var_dump($h->sendCmd($from, $target_type, $target, $action));
...
case 35: //发送文本消息
	...
	$ext['a'] = "a";
	$ext['b'] = "b";
	var_dump($h->send($from, $target_type, $target, $content, $ext));
	break;
case 36: //发送透传消息
	$from = 'admin';
	$target_type = "users";
	//$target_type="chatgroups";
	$target = array("tennessine", "w3hacker");
